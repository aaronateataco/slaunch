-- Quote widget. Fetches a short inspirational quote (ZenQuotes public API) and
-- word-wraps it to the card width. A fresh quote arrives roughly every 30 min.
-- No options - enable/disable in Theming > Widgets.
