-- Crypto price widget (CoinGecko public API). Shows the current fiat price of a
-- few coins. Edit the coin list and currency in Theming > Widgets > Crypto:
--   Coins    - comma-separated CoinGecko ids, e.g. "bitcoin,ethereum,solana"
--   Currency - a fiat code, e.g. "usd", "eur", "gbp"
