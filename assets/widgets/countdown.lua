-- Countdown widget. Counts the days until (or since) a target date, read from
-- the console clock - no network. Set the label and date in
-- Theming > Widgets > Countdown. Date format is YYYY-MM-DD.
